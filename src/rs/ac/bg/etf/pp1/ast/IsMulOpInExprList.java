...
public class IsMulOpInExprList extends MulOpInExprList {

    private MulOpInExprList MulOpInExprList;
    private Mulop Mulop;
    private Factor Factor;

    public IsMulOpInExprList (MulOpInExprList MulOpInExprList, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IsMulOpInExprList(\n");
