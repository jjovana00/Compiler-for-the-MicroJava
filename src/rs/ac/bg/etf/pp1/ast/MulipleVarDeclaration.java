...
public class MulipleVarDeclaration extends VarDeclarationList {

    private VarDeclarationList VarDeclarationList;
    private VarDeclaration VarDeclaration;

    public MulipleVarDeclaration (VarDeclarationList VarDeclarationList, VarDeclaration VarDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulipleVarDeclaration(\n");
