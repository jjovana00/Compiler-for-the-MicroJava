...
public class DesignatorMatirx extends Designator {

    private DesignatorArrayName DesignatorArrayName;
    private Expr Expr;
    private Expr Expr1;

    public DesignatorMatirx (DesignatorArrayName DesignatorArrayName, Expr Expr, Expr Expr1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorMatirx(\n");
